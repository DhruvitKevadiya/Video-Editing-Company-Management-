...
const ProjectExposingQuotation = () => {
  const { id } = useParams();
  ...
  return (
    <div>
      ...
      <div class="quotation-details-wrapper border radius15">
        <div class="quotation-details-head p10 border-bottom d-flex justify-content-between">
          <h3 class="fw_600 m-0">Final Work</h3>

          <div className="assigned_exposer">
            {clientProjectOverviewData?.sent_confirmation &&
            clientProjectOverviewData?.client_confirmation ? (
              <div className="confection_text">
                <img src={InfoSuccess} alt="" />
                <h6 className="m-0 text_green">
                  Data Received Confirm on{' '}
                  {moment(
                    clientProjectOverviewData?.client_confirmation_at,
                  ).format('MMMM Do YYYY')}{' '}
                  at{' '}
                  {moment(
                    clientProjectOverviewData?.client_confirmation_at,
            ...
            ) : clientProjectOverviewData?.sent_confirmation === true ? (
              <Button
        ...
        <div className="saved_quotation py20 px10">
          <Link to="/" className="link_text_blue">
            <p className="m-0">{clientProjectOverviewData?.final_work}</p>
          </Link>
        </div>
      </div>
        ...
        <div className="delete_popup_wrapper conformation_wrapper">
          ...
          <div className="conformation_msg">
            <p>
              ...
              In the future, <span>'Smile Films'</span> won't be liable for any
              data loss, Click<span> 'Confirm'</span> if you've received the
              data.
            </p>
          </div>
...
export default memo(ProjectExposingQuotation);
